        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 2:
                    ...
                    initAtStart.boolValue = MUIPEditorHandler.DrawToggle(initAtStart.boolValue, customSkin, "Initialize At StartExamination");
                    invokeAtStart.boolValue = MUIPEditorHandler.DrawToggle(invokeAtStart.boolValue, customSkin, "Invoke At StartExamination");
